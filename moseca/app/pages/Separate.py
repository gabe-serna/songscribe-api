...
from moseca.app.footer import footer
from moseca.app.header import header
from moseca.app.helpers import (
    load_audio_segment,
    load_list_of_songs,
    plot_audio,
    url_is_valid,
...
from moseca.app.service.demucs_runner import separator
from moseca.app.service.vocal_remover.runner import load_model, separate
from moseca.app.style import CSS_TABS
...
def body():
        ...
        if option == "Examples":
            ...
            if uploaded_file is not None:
                with st.spinner("Loading audio..."):
                    ...
                    file_path = in_path / uploaded_file.name
    ...
    if filename is not None:
        ...
        song = load_audio_segment(file_path, file_extension)
